        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" className="flex items-center justify-center bg-warm-orange hover:bg-warm-orange/90 text-white px-8 py-4 text-lg">
                Find Services
              ...
              <Button
                size="lg"
                variant="outline"
                className="flex items-center justify-center border-2 border-warm-orange text-warm-orange hover:bg-warm-orange hover:text-white px-8 py-4 text-lg"
              >
